...
public class Finance {
    ...
    public final static Map<String,String> commandsToUsage = Map.of(BEST_LOAN_RATES, "usage: bestLoanRates",
            SAVINGS_CALCULATOR, "usage: savingsCalculator <credits separated by ','> <debits seperated by ','>",
            MORTGAGE_CALCULATOR, "usage: mortgageCalcualtor <loanAmount> <termInYears> <annualRate>");
